...
public:
    ...
    // function to open the connection to the database
    {
        Employ = QSqlDatabase::addDatabase("QSQLITE");                        // add the database into the project
               ...
               Employ.setDatabaseName("../EMP/android/assets/db/Employ.db"  );   // sets the database name in the file destintaion
...
private slots:
    ...
    void on_LBox_currentIndexChanged(const QString &arg1);
