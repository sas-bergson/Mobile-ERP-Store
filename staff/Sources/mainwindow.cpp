...

{
  MainWindow  conn;
    ...
    QFile dfile("assets:/db/Employ.db" ) ;
...
//        }
        dfile.copy("../EMP/android/assets/db/Employ.db" );
        QFile::setPermissions("../EMP/android/assets/db/Employ.db" ,QFile::WriteOwner | QFile::ReadOwner | QFile::ExeOwner);
        this->connectionOpen();
    }
